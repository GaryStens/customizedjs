    ...
    Import: function(module) {
        try {
            ...
            if (module.includes('/')) {
                ...
                console.log('\x1b[31mYou can fix the problem at the /node-modules/customizedjs file!')
                console.log('\x1b[31m')
            ...
            console.log('\x1b[31mError: Failed to import \'' + module + '\':')
            console.log('\x1b[31m')
            console.log('\x1b[31mImport stack:')
            console.log('\x1b[31mof a failed module bytes.')
            console.log('\x1b[31mof a failed import bytes.')
            console.log('\x1b[31m')
            console.log('\x1b[31mMore Information:')
